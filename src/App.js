...
function App() {
  ...
  const openHistory = () => {
    const linkToOpen = CHAIN_EXPLORER +  address;
  ...
  const loggedInView = (
    <>
      ...
      <button onClick={openHistory} className="card" style={styles.button}>
        Tx History
      </button>
  ...
  return (
    ...
    >
      ...
      Coding Test for Emmanuel using Web3Auth
      </h3>
          ...
          <div className="col-md-8">
            <div style={styles.card}>
              ...
              <h6 style={{ color: "#000000", fontWeight: 300, fontSize: 16 }}>
                Login with your social account to enable the world of
                crypto
              </h6>
              <button
                style={{
